...
class TestTicTacToeEngineAdditional(TestTicTacToeEngine):
    ...
    def test_proper_initialization(self):
        ...
        self.assertTrue(np.array_equal(self.engine.current_board.board, np.full((3, 3), -1)))
