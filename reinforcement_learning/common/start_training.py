...
if __name__ == '__main__':
    ...
    print(f"episodes: {len(agents[0]._all_episodes_rewards)}")
    plt.plot(agents[0].get_performance_graph(20), label="N step")
    plt.plot(agents[1].get_performance_graph(20), label="Q learning")
    plt.gca().legend(('N step', 'Q learning'))
    plt.show()
