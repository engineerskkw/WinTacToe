...
from reinforcement_learning.agents.common_building_blocks.epsilon_strategy import CircleEpsilonStrategy, DecayingSinusEpsilonStrategy

# Training
from reinforcement_learning import SimpleTraining
...
if __name__ == '__main__':
    ...
    agent_0_file_path = os.path.join(ABS_PROJECT_ROOT_PATH, "reinforcement_learning", "trained_agents", "agent0.rl_agent")
    agent_1_file_path = os.path.join(ABS_PROJECT_ROOT_PATH, "reinforcement_learning", "trained_agents", "agent1.rl_agent")
